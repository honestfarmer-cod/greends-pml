...
- Exercise: define a Linear Regression class to with methods `.fit`and `.predict` and visualize the itereative process to find the optimal weights. See [exercise](docs/T1_Create_LInearRegression_class_fit_predict_visualize.md).
